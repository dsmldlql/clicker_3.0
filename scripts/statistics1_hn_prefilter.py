# statistics1_hn_prefilter.py
# Считаем статистику с п., пп., частями (art_part)
...
def main():
    """Main function to calculate statistics with art_part."""
    ...
    for question_id, file_paths in grouped_files.items():
        ...
        for file_path in file_paths:
            ...
            for norm in norms:
                ...
                # Include art_part/art_chast in comparison tuple
                art_part = norm.get("art_part", "") or norm.get("art_chast", "")
    ...
    output_file = ANSWERS_DIR.parent / "statistics1_output.csv"
